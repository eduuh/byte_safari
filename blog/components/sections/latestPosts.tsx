  ...
  return (
    <section>
      <div className="container mx-auto">
        <h2 className="text-base font-medium uppercase tracking-wider mb-9 text-secondary-light dark:text-secondary-dark">Articles and Tutorials</h2>
          ...
          {postsMeta?.map((meta) => (
            ...
            >
              ...
              <div className="flex flex-col space-y-2 py-2">
                ...
                {false && <PostDetails date={meta.date.split(' ').slice(0, 4).join(' ')} status={meta.status} />}
              </div>
            </div>
          ))}
        </div>
